...
class home extends Component {
	...
	searchEvents = e => {
		...
		axios
			.get(
				`https://app.ticketmaster.com/discovery/v2/events.json?countryCode=US&apikey=eIMh2CGNhtUTSybN21TU3JRes1j9raV3&radius=50&city=${city}&sort=date,desc&classificationName=[music]&unit=miles`
			)
			.then(response => {
				console.log(
