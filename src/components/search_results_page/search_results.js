            ...
            <div className="filters">
                ...
                <div className='filter-container'>
                    ...
                    <select name='genreId' onChange={e => this.handleUserInput(e)} >
                        <option 
                            value='KnvZfZ7vAvv,KnvZfZ7vAve,KnvZfZ7vAvd,KnvZfZ7vAvA,KnvZfZ7vAvk,KnvZfZ7vAeJ,KnvZfZ7vAv6,KnvZfZ7vAvF,KnvZfZ7vAva,KnvZfZ7vAv1,KnvZfZ7vAvJ,KnvZfZ7vAvE,KnvZfZ7vAvI,KnvZfZ7vAvt,KnvZfZ7vAvn,KnvZfZ7vAvl,KnvZfZ7vAev,KnvZfZ7vAee,KnvZfZ7vAed,KnvZfZ7vAe7,KnvZfZ7vAeA,KnvZfZ7vAeF'
                        >
                        All Genres
                        </option>
            ...
            <div className="events-list">
                {
                    this.props.events 
                    ? eventsList
                    : <h1>NOTHING TO SEE HERE LADDY</h1>
                }
            </div>
        </div> 
    )
...
export default connect(mapStateToProps, { setEvents, setCity })(search_results);
